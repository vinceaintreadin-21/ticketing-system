...
<body class="bg-gray-100 min-h-screen font-sans">
    <nav class="flex justify-between items-center p-4 bg-white shadow-sm">
        ...
        <a href="{{route('register-form')}}" class="text-blue-500 hover:text-blue-700">Register</a>
    </nav>
    <main class="container mx-auto px-4 py-8 flex items-center justify-center min-h-screen bg-gray-100">
        <form method="POST" action="{{ route('login') }}" class="bg-white p-6 rounded-lg shadow-md w-80">
            @csrf
